...
class AwsCdk3TierRDSStack(core.Stack):

    def __init__(self, scope: core.Construct, id: str, vpc, asg_security_groups, ** kwargs) -> None:
        super().__init__(scope, id, **kwargs)

        # Create an RDS Database:
        hui_db = _rds.DatabaseInstance(self,
                                            "huiRDS",
                                            #master_username="huimaster",
                                            database_name="hui_db",
        ...
        output_1 = core.CfnOutput(self,
                                  ...
                                  value=f"mysql -h {hui_db.db_instance_endpoint_address} -P 3306 -u mystiquemaster -p",
