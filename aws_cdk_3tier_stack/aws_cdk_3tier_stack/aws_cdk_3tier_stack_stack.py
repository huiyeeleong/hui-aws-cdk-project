...
class app_tier_stack(cdk.Stack):

    def __init__(self, scope: cdk.Construct, construct_id: str, vpc, **kwargs) -> None:
        super().__init__(scope, construct_id, **kwargs)

        # The code that defines your stack goes here
        with open("/Users/huiyeeleong/Desktop/hui-aws-cdk-project/aws_cdk_3tier_stack/aws_cdk_3tier_stack/bootstrap_script/install_httpd.sh"
        , mode="r") as file: 
            user_data = file.read()
